...
// import
// net.banatech.diy_dev_diary.infrastructure.controllers.forms.CreateUserDataForm;
...
// @PostMapping(value = "/api/users", produces =
// MediaType.APPLICATION_JSON_VALUE)
// public User createUserData(@RequestBody CreateUserDataForm
// createUserDataForm) {
